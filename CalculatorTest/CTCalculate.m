...
-(NSString *) solveQuestion:(NSString *) question
{
    ...
    {
        NSString *nextChar = [question firstElement];// Remove first character from string
        question = [question stringByRemovingFirstElement];
        CTElementType elementType = [nextChar getElementType];
        ...
        else//If operand
        {
            ...
            if(topOperand != nil && [topOperand precedes:nextChar])//if the previous operand has a higher precedence solve a single calculation
            {
